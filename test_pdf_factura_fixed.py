#!/usr/bin/env python3
"""
Script corregido para procesar testfactura.pdf y crear factura en Alegra
"""
...
def extract_items_from_pdf(text):
    ...
    # "ROYAL CANIN GATO GASTROINTESTINAL FIBRE x2KG"
...
def main():
    """Función principal"""
    print("🚀 InvoiceBot - Procesamiento de testfactura.pdf (Versión Corregida)")
    print("=" * 70)
