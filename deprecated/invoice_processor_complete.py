#!/usr/bin/env python3
"""
Sistema completo de procesamiento de facturas - Compra y Venta
"""
...
def ask_invoice_type():
    """Preguntar al usuario si es factura de compra o venta"""
    print("\n🤔 ¿Qué tipo de factura es?")
    print("=" * 40)
    print("1. 📥 Factura de COMPRA (Invoice) - Se registra en el sistema")
    print("2. 📤 Factura de VENTA (Sale) - Se crea para enviar al cliente")
    print()
...
def main():
    """Función principal"""
    print("🚀 InvoiceBot - Sistema Completo de Facturas")
    print("=" * 60)
    
    pdf_path = "/Users/arielsanroj/Downloads/testfactura.pdf"
    
    # Paso 1: Preguntar tipo de factura
    invoice_type = ask_invoice_type()
